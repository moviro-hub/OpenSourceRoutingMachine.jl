...
shell pipelines.
"""
function osrm_partition(osrm_base::AbstractString;
                        extra_args::Vector{String}=String[])
...
"""
function osrm_customize(osrm_base::AbstractString;
                        extra_args::Vector{String}=String[])
...
"""
function osrm_contract(osrm_base::AbstractString;
                       extra_args::Vector{String}=String[])
